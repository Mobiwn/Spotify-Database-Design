...
3. Run the SQL code provided in the [database-design.sql](https://github.com/Mobiwn/Spotify-Database-Design/tree/main/Source%20Code) file to create the necessary tables.
